...
class Data_wisata extends MY_Controller
{
    ...
    public function index()
    {
      ...
      $data = array(
        'contain_view' => '{namamodule}/data_wisata/data_wisata_list',
    ...
    public function create(){
      $data = array(
        'contain_view' => '{namamodule}/data_wisata/data_wisata_form',
        ...
        'action'=>'{namamodule}/data_wisata/create_action'
       );
      $this->template->load($data);
    }
    ...
    public function edit($id){
      ...
      $data = array(
        'contain_view' => '{namamodule}/data_wisata/data_wisata_edit',
        'sidebar'=>'{namamodule}/sidebar',//Ini buat menu yang ditampilkan di module admin {DIKIRIM KE TEMPLATE}
        'css'=>'{namamodule}/crudassets/css',//Ini buat kirim css dari page nya  {DIKIRIM KE TEMPLATE}
        'script'=>'{namamodule}/crudassets/script',//ini buat javascript apa aja yang di load di page {DIKIRIM KE TEMPLATE}
        'action'=>'{namamodule}/data_wisata/update_action',
        'dataedit'=>$dataedit
       );
      $this->template->load($data);
    }
    ...
    public function create_action()
    {
		...
		'htm_anak' => $this->input->post('htm_anak',TRUE),
            ...
            redirect(site_url('{namamodule}/data_wisata'));
        }
    }
