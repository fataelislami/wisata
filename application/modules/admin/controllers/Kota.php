...
class Kota extends MY_Controller
{
    ...
    public function export(){
      ...
      $excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA KOTA"); // Set kolom A1 dengan tulisan "DATA SISWA"
      ...
      $excel->getActiveSheet(0)->setTitle("Laporan Data Kota");
      $excel->setActiveSheetIndex(0);

      // Proses file excel
      header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
      header('Content-Disposition: attachment; filename="Data Kota.xlsx"'); // Set nama file excel nya
