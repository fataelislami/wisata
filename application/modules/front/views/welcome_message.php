...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url()?>frontend_assets/assets/bootstrap/css/bootstrap.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url()?>frontend_assets/assets/fonts/font-awesome.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url()?>frontend_assets/assets/css/selectize.css" type="text/css">
    <link rel="stylesheet" href="<?php echo base_url()?>frontend_assets/assets/css/style.css">
    <link rel="stylesheet" href="<?php echo base_url()?>frontend_assets/assets/css/user.css">

	<title>ATOL WISATA</title>
...
<body>
                    ...
                    <div class="container">
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            <a class="navbar-brand" href="index.html">
                                <img src="<?php echo base_url()?>frontend_assets/assets/img/logo.png" alt="">
                            </a>
                            ...
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-01.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-02.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-03.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="feature-box">
                                    <figure>
                                        <img src="<?php echo base_url()?>frontend_assets/assets/icons/feature-user.png" alt="">
                                        <span>1</span>
                                    </figure>
                            ...
                            <div class="col-md-3">
                                <div class="feature-box">
                                    <figure>
                                        <img src="<?php echo base_url()?>frontend_assets/assets/icons/feature-upload.png" alt="">
                                        <span>2</span>
                                    </figure>
                            ...
                            <div class="col-md-3">
                                <div class="feature-box">
                                    <figure>
                                        <img src="<?php echo base_url()?>frontend_assets/assets/icons/feature-like.png" alt="">
                                        <span>3</span>
                                    </figure>
                                    <h3>Make a Deal</h3>
                            ...
                            <div class="col-md-3">
                                <div class="feature-box">
                                    <figure>
                                        <img src="<?php echo base_url()?>frontend_assets/assets/icons/feature-wallet.png" alt="">
                                        <span>4</span>
                                    </figure>
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-04.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-05.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            ...
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-06.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-07.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-08.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-09.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-10.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                        ...
                        <div class="item">
                            <div class="wrapper">
                                <div class="image">
                                    ...
                                    <a href="single-listing-1.html" class="image-wrapper background-image">
                                        <img src="<?php echo base_url()?>frontend_assets/assets/img/image-11.jpg" alt="">
                                    </a>
                                </div>
                                <!--end image-->
                                <h4 class="location">
                    ...
                    <div class="box has-dark-background">
                        ...
                        <div class="background">
                            <div class="background-image">
                                <img src="<?php echo base_url()?>frontend_assets/assets/img/hero-background-image-01.jpg" alt="">
                            </div>
            ...
            <section class="block">
                <div class="container">
                    <div class="d-flex align-items-center justify-content-around">
                        <a href="#">
                            <img src="<?php echo base_url()?>frontend_assets/assets/img/partner-1.png" alt="">
                        </a>
                        <a href="#">
                            <img src="<?php echo base_url()?>frontend_assets/assets/img/partner-2.png" alt="">
                        </a>
                        <a href="#">
                            <img src="<?php echo base_url()?>frontend_assets/assets/img/partner-3.png" alt="">
                        </a>
                        <a href="#">
                            <img src="<?php echo base_url()?>frontend_assets/assets/img/partner-4.png" alt="">
                        </a>
                        <a href="#">
                            <img src="<?php echo base_url()?>frontend_assets/assets/img/partner-5.png" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div class="wrapper">
                ...
                <div class="background">
                    <div class="background-image original-size">
                        <img src="<?php echo base_url()?>frontend_assets/assets/img/footer-background-icons.jpg" alt="">
                    </div>
                    <!--end background-image-->
                </div>
                <!--end background-->
	...
	<script src="<?php echo base_url()?>frontend_assets/assets/js/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url()?>frontend_assets/assets/js/popper.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url()?>frontend_assets/assets/bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyB3sQdBeiGlXTeWmWAOffst7X8syIzs2vY&libraries=places"></script>
    <!--<script type="text/javascript" src="http://maps.google.com/maps/api/js"></script>-->
	<script src="<?php echo base_url()?>frontend_assets/assets/js/selectize.min.js"></script>
	<script src="<?php echo base_url()?>frontend_assets/assets/js/masonry.pkgd.min.js"></script>
	<script src="<?php echo base_url()?>frontend_assets/assets/js/icheck.min.js"></script>
	<script src="<?php echo base_url()?>frontend_assets/assets/js/jquery.validate.min.js"></script>
	<script src="<?php echo base_url()?>frontend_assets/assets/js/markerclusterer_packed.js"></script>
	<script src="<?php echo base_url()?>frontend_assets/assets/js/infobox.js"></script>
	<script src="<?php echo base_url()?>frontend_assets/assets/js/richmarker-compiled.js"></script>
	<script src="<?php echo base_url()?>frontend_assets/assets/js/map.js"></script>
	<script src="<?php echo base_url()?>frontend_assets/assets/js/custom.js"></script>

    <!-- <script>
        var latitude = -6.917464;
        var longitude = 107.619123;
    ...
    var latitude = -6.917464;
    var longitude = 107.619123;
    var markerImage = "<?php echo base_url()?>frontend_assets/assets/img/map-marker.png";
    var mapTheme = "light";
    var mapElement = "map-homepage";
